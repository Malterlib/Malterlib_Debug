...
def fg_MibLLDBInit_Exception(_Debugger):
	...
	fg_AddSynth(_Debugger, CSynthProvider_NException_CExceptionBase, "(^|^const )NMib::NCryptography::CExceptionCryptography$", True)
	...
	fg_AddSummary(_Debugger, fg_SummaryProvider_CExceptionBase, "(^|^const )NMib::NCryptography::CExceptionCryptography$", True)
