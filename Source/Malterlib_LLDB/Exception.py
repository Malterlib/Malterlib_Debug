...
def fg_MibLLDBInit_Exception(_Debugger):
	...
	fg_AddSynth(_Debugger, CSynthProvider_NException_CExceptionBase, "(^|^const )NMib::NNet::CExceptionNet$", True)
	...
	fg_AddSynth(_Debugger, CSynthProvider_NException_CExceptionBase, "(^|^const )NMib::NMem::CExceptionMemoryManagerDebug$", True)
	fg_AddSynth(_Debugger, CSynthProvider_NException_CExceptionBase, "(^|^const )NMib::NRegistry::CExceptionRegistry$", True)
	...
	fg_AddSummary(_Debugger, fg_SummaryProvider_CExceptionBase, "(^|^const )NMib::NNet::CExceptionNet$", True)
	...
	fg_AddSummary(_Debugger, fg_SummaryProvider_CExceptionBase, "(^|^const )NMib::NMem::CExceptionMemoryManagerDebug$", True)
	fg_AddSummary(_Debugger, fg_SummaryProvider_CExceptionBase, "(^|^const )NMib::NRegistry::CExceptionRegistry$", True)
