				...
				)
			{
				...
				auto fl_GenerateException
					= [&_pExceptionMemoryData, _pExceptionInfo](NThread::CThreadObjectNonTracked *_pThread) -> aint
					{
						...
						NStr::CStrNonTracked CrashDumpPath = NFile::NPlatform::fg_ConvertFromWindowsPath<NStr::CWStrNonTracked, NStr::CWStrNonTracked>(NSys::fg_Process_GetEnvironmentVariable(NStr::CStrNonTracked("IdsCrashDumpDir")));
